...
IPANDPORT = []
# TARGET_HOST = 'http://ft.10jqka.com.cn/thsft/f9service2?lx=stock_8&thscode=%s'#股东基本资料
# TARGET_HOST = 'http://ft.10jqka.com.cn/thsft/f9service2?lx=stock_9&thscode=%s'#
# TARGET_HOST = 'http://ft.10jqka.com.cn/thsft/f9service2?lx=stock_10&thscode=%s'#股东增持实施
TARGET_HOST = 'http://ft.10jqka.com.cn/thsft/f9service2?lx=stock_11&thscode=%s'#上市时间表
...
def run_pro(target_url, line):
    ...
    if len(result.text) > 0:
        with codecs.open(u'/Users/liangxiansong/Desktop/上市时间表/%s' % line + '.txt', 'w+') as file:
